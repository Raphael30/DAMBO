const examQuestions = [
    ...
    {
        id: 60,
        question: "A network administrator has enabled full SSL inspection and web filtering on FortiGate. When visiting any HTTPS websites, the browser reports certificate warning errors. When visiting HTTP websites, the browser does not report errors. What is the reason for the certificate warning errors?",
    ...
    {
        id: 62,
        question: "An administrator wants to form an HA cluster using the FGCP protocol. Which two requirements must the administrator ensure both members fulfill? (Choose two.)",
    ...
    {
        id: 63,
        question: "FortiGate is integrated with FortiAnalyzer and FortiManager. When creating a firewall policy, which attribute must an administrator include to enhance functionality and enable log recording on FortiAnalyzer and FortiManager?",
    ...
    },
    {
        ...
        options: ["Configure the LDAP server IP address and port on the FortiGate.", "Define a user group on the FortiGate and add the remote LDAP server as a member.", "Configure the FortiGate to send an authentication request to the LDAP server.", "Ensure that the LDAP server is reachable from the FortiGate."],
        answer: "AD",
        image: ["images/q68_1.png", "images/q68_2.png", "images/q68_3.png", "images/q68_4.png"]
    },
    {
        id: 69,
        question: "Which two conditions must be met for a FortiGate to perform an HA failover in an Active-Passive cluster? (Choose two.)",
        options: ["The monitored interface on the primary unit goes down.", "The HA heartbeat interface on the primary unit goes down.", "The secondary unit's priority is lower than the primary unit's priority.", "The primary unit loses power."],
        answer: "AD",
        image: "images/q69.png"
    },
    {
        id: 70,
        question: "What is the primary function of the 'config system probe-response' command on FortiGate?",
        options: ["To monitor the health of SD-WAN members.", "To respond to ICMP probes from a third-party monitoring tool.", "To enable LLDP on the interface.", "To configure the FortiGate as a DHCP server."],
        answer: "B",
        image: null
    },
    {
        id: 71,
        question: "What are two features of collector agent advanced mode?",
    ...
    },
    {
        ...
        options: ["Configure the SSL VPN to use a different port than 443.", "Keep port 443 for both SSL VPN and HTTPS administrative access on the same interface without any problems.", "Run SSL VPN on one interface using port 443 and enable HTTPS administrative access on a different interface, also using port 443.", "Change the port number for either the SSL VPN service or the HTTPS administrative service if both are on the same interface."],
        answer: "CD",
    ...
    {
        id: 74,
        question: "Refer to the exhibits. You have implemented the application sensor and the corresponding firewall policy as shown in the exhibits. You cannot access any of the Google applications, but you are able to access www.fortinet.com. What would you do to resolve this issue?",
        options: ["Change the Inspection mode to Proxy-based.", "Set SSL inspection to deep-content-inspection.", "Move up Google in the Application and Filter Overrides section to set its priority to 1.", "Change the Action for Google in the application sensor to Allow."],
        answer: "B",
        image: "images/q74.png"
    },
    {
        id: 75,
        question: "Which two statements about the Security Rating section in the Security Fabric are true? (Choose two.)",
    ...
    {
        id: 76,
        question: "An administrator has configured the following settings:\nconfig system settings\nset ses-denied-traffic enable\nend\nconfig system global\nset block-session-timer 30\nend\n\nWhat are the two results of this configuration? (Choose two.)",
        options: ["Denied users are blocked for 30 minutes.", "A session for denied traffic is created.", "Session helpers are disabled for denied traffic.", "The number of logs generated by denied traffic is reduced."],
        answer: "BD",
        image: ["images/q76_1.png", "images/q76_2.png", "images/q76_3.png"]
    },
    {
        id: 77,
        question: "Refer to the exhibits. You have implemented the application sensor and the corresponding firewall policy as shown in the exhibits. You cannot access any of the Google applications, but you are able to access www.fortinet.com. Which two actions would you take to resolve the issue? (Choose two.)",
    ...
    {
        id: 78,
        question: "Refer to the exhibits. You have implemented the application sensor and the corresponding firewall policy as shown in the exhibits. Which two factors can you observe from these configurations? (Choose two.)",
        options: ["Facebook access is allowed but you cannot post any status updates.", "Applications that do not match explicitly configured overrides will be allowed.", "Application control logging is disabled globally.", "Traffic that matches the firewall policy will be processed using flow-based inspection."],
        answer: "BD",
    ...
    },
    {
        ...
        options: ["They can have one or more triggers.", "They can be created only on downstream devices in the fabric.", "They can run multiple actions at the same time.", "They can be run only on devices in the Security Fabric."],
        answer: "C",
    ...
    },
    {
        ...
        options: ["The antivirus profile has been disabled for FTP traffic.", "The firewall policy doesn't have an SSL inspection profile applied.", "The inspection mode must be set to Proxy-based.", "The action in the antivirus profile is set to monitor only."],
        answer: "B",
    ...
    },
    {
        ...
        options: ["NTurbo buffers the whole file and then sends it to the antivirus engine.", "NTurbo creates a special data path to redirect traffic between the IPS engine its ingress and egress interfaces.", "NTurbo creates two inspection sessions on the FortiGate device.", "NTurbo offloads traffic to the content processor."],
        answer: "B",
    ...
    },
    {
        ...
        options: ["Policy ID", "Log ID", "Universally Unique Identifier", "Sequence ID"],
        answer: "C",
        image: ["images/q97_1.png", "images/q97_2.png"]
    },
    {
        id: 98,
        question: "Refer to the exhibit. The administrator configured SD-WAN rules and set the FortiGate traffic log page to display SD-WAN-specific columns: SD-WAN Quality and SD-WAN Rule Name. FortiGate allows the traffic according to policy ID 1 placed at the top. This is the policy that allows SD-WAN traffic. Despite these settings, the traffic logs do not show the name of the SD-WAN rule used to steer those traffic flows. What could be the reason?",
        options: ["SD-WAN rule names do not appear immediately. The administrator must refresh the page.", "The traffic log is flow-based and does not capture rule mapping details.", "Log traffic was not set to All Sessions under the firewall policy configuration.", "The SD-WAN rules are evaluated dynamically and are not cached by the logging daemon."],
        answer: "C",
    ...
    },
    {
        ...
        options: ["Change the Inspection mode to Proxy-based.", "Set SSL inspection to deep-content-inspection.", "Move up Google in the Application and Filter Overrides section to set its priority to 1.", "Change the Action for Google in the application sensor to Allow."],
        answer: "B",
        image: ["images/q108_1.png", "images/q108_2.png"]
    },
    {
        id: 109,
        question: "Which two statements about the Security Rating section in the Security Fabric are true? (Choose two.)",
    ...
    {
        id: 126,
        question: "Refer to the exhibit showing a packet capture. Why did FortiGate drop the packet during evaluation?",
        options: ["The matching firewall policy has a DENY action.", "The next-hop route was removed while processing.", "It failed the reverse path forwarding (RPF) sanity checks.", "An anomaly signature matched within the IPS core module."],
        answer: "A",
