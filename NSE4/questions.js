const examQuestions = [
    ...
    {
        id: 2,
        question: "You have created a web filter profile named restrict media-profile with a daily category usage quota. When you are adding the profile to the firewall policy, the restrict_media-profile is not listed in the available web profile drop-down. What could be the reason?[cite: 2]",
    ...
    {
        id: 3,
        question: "Refer to the exhibit. As an administrator, you have created an IPS profile, but it is not performing as expected. While testing, you got the output as shown in the exhibit. What could be the possible reason for the diagnostic output shown in the exhibit?[cite: 2]",
        options: ["There is no firewall policy configured with an IPS security profile.", "FortiGate entered into IPS fail-open state.", "Administrator entered the command diagnose test application ipsmonitor 5.", "Administrator entered the command diagnose test application ipsmonitor 99."],
        answer: "A",
        image: "images/q3.png"
    },
    {
        id: 4,
        question: "Refer to the exhibit. The predefined deep-inspection and custom-deep-inspection profiles exclude some web categories from SSL inspection, as shown in the exhibit. For which two reasons are these web categories exempted? (Choose two.)[cite: 2]",
    ...
    {
        id: 5,
        question: "Refer to the exhibit. The NOC team connects to the FortiGate GUI with the NOC_Access admin profile. They request that their GUI sessions do not disconnect too early during inactivity. What must the administrator configure to answer this specific request from the NOC team?[cite: 2]",
    ...
    },
    {
        ...
        options: ["Administrators cannot change the configuration.", "FortiGate skips quarantine actions.", "Administrators must restart FortiGate to allow new sessions.", "FortiGate drops new sessions requiring inspection."],
        answer: "AB",
        image: "images/q6.png"
    },
    {
        id: 7,
        question: "What is the primary FortiGate election process when the HA override setting is enabled?[cite: 2]",
    ...
    {
        id: 10,
        question: "Refer to the exhibit, which shows a partial configuration from the remote authentication server. Why does the FortiGate administrator need this configuration? [cite: 2]",
    ...
    {
        id: 11,
        question: "Refer to the exhibit, which shows an SD-WAN zone configuration on the FortiGate GUI. Based on the exhibit, which statement is true? [cite: 2]",
    ...
    {
        id: 13,
        question: "Refer to the exhibit. An administrator has configured an ApplicationOverrides for the ABC.Com application signature and set the Action to Allow. This application control profile is then applied to a firewall policy that is scanning all outbound traffic. Logging is enabled in the firewall policy. To test the configuration, the administrator accessed the ABC.Com website several times. Why are there no logs generated uunder securitylogs for ABC.Com?[cite: 2]",
    ...
    },
    {
        ...
        options: ["They rely on session loss and jitter.", "They can be measured actively or passively.", "They are applied in an SD-WAN rule lowest cost strategy.", "They monitor the state of the FortiGate device.", "All the SLA targets can be configured."],
        answer: "BCE",
    ...
    },
    {
        ...
        options: ["The selected SSL inspection profile has certificate inspection enabled.", "The website is exempted from SSL inspection.", "The El CAR test file exceeds the protocol options oversize limit.", "The browser does not trust the FortiGate self-signed CA certificate."],
        answer: "AB",
    ...
    {
        id: 22,
        question: "A network administrator is reviewing firewall policies in both Interface Pair View and By Sequence View. The policies appear in a different order in each view. Why is the policy order different in these two views?[cite: 2]",
    ...
    {
        id: 23,
        Question: "An administrator notices that some users are unable to establish SSL VPN connections, while others can connect without any issues. What should the administrator check first? [cite: 2]",
    ...
    {
        id: 27,
        question: "You are analyzing connectivity problems caused by intermediate devices blocking traffic in an SSL VPN environment. In which two ways can you effectively resolve the problem? (Choose two.)[cite: 2]",
    ...
    {
        id: 28,
        question: "Refer to the exhibit. FortiGate has two separate firewall policies for Sales and Engineering to access the same web server with the same security profiles. Which action must the administrator perform to consolidate the two policies into one?[cite: 2]",
    ...
    {
        id: 29,
        question: "You have configured an application control profile, set peer-to-peer traffic to Block under the Categories tab, and applied it to the firewall policy. However, your peer-to-peer traffic on known ports is passing through the FortiGate without being blocked. What FortiGate settings should you check to resolve this issue?[cite: 2]",
    ...
    {
        id: 30,
        question: "When configuring firewall policies, which of the following is true regarding the policy ID? [cite: 2]",
    ...
    {
        id: 32,
        question: "A remote user reports slow SSL VPN performance and frequent disconnections. The user is located in an area with poor internet connectivity. What setting should the administrator adjust to improve the user's experience?[cite: 2]",
    ...
    {
        id: 34,
        question: "An administrator suspects that the Collector Agent is not forwarding login events to FortiGate. What is the most effective troubleshooting step? [cite: 2]",
    ...
    {
        id: 35,
        question: "Refer to the exhibit. A network administrator is troubleshooting an IPsec tunnel between two FortiGate devices. The administrator has determined that phase 1 status is up, but phase 2 fails to come up. Based on the phase 2 configuration shown in the exhibit, which two configuration changes will bring phase 2 up? (Choose two.)[cite: 2]",
        options: ["On BR1-FGT, set Seconds to 43200.", "On HQ-NGFW, enable Diffie-HellmanGroup 2.", "On BR1-FGT, set Remote Address to 10.0.11.0/255.255.255.0", "On HQ-NGFW, set Encryption to AES256"],
        answer: "CD",
    ...
    {
        id: 37,
        question: "Which statement correctly describes NetAPI polling mode for the FSSO collector agent? [cite: 2]",
    ...
    {
        id: 38,
        question: "You have configured the FortiGate device for FSSO. A user is successful in logging in to Windows, but their access to the internet is denied. What should the administrator check first? [cite: 2]",
        options: ["Whether the user is assigned to the correct AD group.", "The FortiGate firewall policy settings for SSL decryption.", "The FortiGate FSSO active users list for the user’s IP address.", "The Windows Event Viewer for failed login attempts."],
        answer: "C",
        image: "images/q38.png"
    },
    {
        id: 39,
        question: "What are three key routing principles in SD-WAN? (Choose three.)[cite: 2]",
    ...
    {
        id: 43,
        question: "Refer to the exhibits. Based on the current HA status, an administrator updates the override and priority parameters on HQ-NGFW-1 and HQ-NGFW-2 as shown in the exhibit. What would be the expected outcome in the HA cluster?[cite: 2]",
        options: ["HQ-NGFW-1 will synchronize the override disable setting with HQ-NGFW-2.", "HQ-NGFW-2 will take over as the primary because it has the override enable setting and higher priority than HQ-NGFW-1.", "HQ-NGFW-1 will remain the primary because HQ-NGFW-2 haslower priority.", "The HA cluster will become out of sync because the override setting must match on all HA members."],
        answer: "B",
        image: "images/q43.png"
    },
    {
        id: 44,
        question: "Refer to the exhibits. An administrator wants to add HQ-ISFW-2 to the Security Fabric. HQ-ISFW-2 is in the same subnet as HQ-ISFW. After configuring the Security Fabric settings on HQ-ISFW-2, the status stays Pending. What can be the two possible reasons? (Choose two.)[cite: 2]",
    ...
    {
        id: 46,
        question: "Which three strategies are valid SD-WAN rule strategies for member selection? (Choose three.)[cite: 2]",
    ...
    {
        id: 50,
        question: "Refer to the exhibit showing a debug flow output. Which two conclusions can you make from the debug flow output? (Choose two.)[cite: 2]",
    ...
    {
        id: 53,
        question: "Refer to the exhibit, which shows a firewall policy to enable active authentication. When attempting to access an external website using an active authentication method, the user is not presented with a login prompt. What is the most likely reason for this situation?[cite: 2]",
    ...
    },
    {
        ...
        options: ["None of the inspected protocols are active in this profile.", "FortiGate, with less than 2 GB RAM, does not support the Antivirus scan feature.", "Antivirusscan is disabled under System –> Feature visibility.", "The Feature Set for the profile is Flow-based, but it must be Proxy-based."],
        answer: "A",
        image: "images/q56.png"
    },
    {
        id: 57,
        question: "An administrator has configured a dialup IPsec VPN on FortiGate with add-route enabled. However, the static route is not showing in the routing table. Which two statements about this scenario are correct? (Choose two.)[cite: 2]",
    ...
    {
        id: 60,
        question: "A network administrator has enabled full SSL inspection and web filtering on FortiGate. When visiting any HTTPS websites, the browser reports certificate warning errors. When visiting HTTP websites, the browser does not report errors. What is the reason for the certificate warning errors?[cite: 2]",
        options: ["The browser does not trust the certificate used by FortiGate for SSL inspection.", "The option invalid SSL certificates is set to allow on the SSL/SSH inspection profile", "The matching firewall policy is set to proxy inspection mode.", "The certificate used by FortiGate for SSL inspection does not contain the required certificate extensions."],
        answer: "A",
    ...
    },
    {
        ...
        options: ["They must have the same HA group ID.", "They must have the heartbeat interfaces in the same subnet.", "They must have the same number of configured VDOMs.", "They must have the same hard drive configuration."],
        answer: "AD",
        image: "images/q62.png"
    },
    {
        id: 63,
        question: "FortiGate is integrated with FortiAnalyzer and FortiManager. When creating a firewall policy, which attribute must an administrator include to enhance functionality and enable log recording on FortiAnalyzer and FortiManager?[cite: 2]",
    ...
    {
        id: 65,
        question: "An administrator manages a FortiGate model that supports NTurbo. How does NTurbo acceleration enhance antivirus performance? [cite: 2]",
        options: ["For proxy-based inspection, NTurbooffloads trafficc to the content processor.", "For flow-based inspection, NTurbo establishes a dedicated data path to redirect traffic between the IPS engine and FortiGate ingress and egress interfaces.", "For proxy-based inspection, NTurbo buffers the whole file and then sends it to the antivirus engine.", "For flow-based inspection, NTurbo creates two inspection sessions on the FortiGate device."],
        answer: "B",
        image: "images/q65.png"
    },
    {
        id: 66,
        question: "Refer to the exhibit. Review the intrusion prevention system (IPS) profile signature settings shown in the exhibit. What can you conclude about the signature when adding the FTP.Login.Failed signature to the IPS Sensor profile?[cite: 2]",
        options: ["The signature setting includes a group of other signatures.", "FortiGate stores a local copy of the packet thatmatches thee signature.", "FortiGate allowsthislow severity signature packet and creates a log.", "The signature setting uses a custom rating threshold"],
        answer: "B",
    ...
    },
    {
        ...
        options: ["Advanced mode supports nested or inherited groups.", "In advanced mode, security profiles can be applied only to user groups, not individual users.", "In advanced mode, FortiGate can be configured as an LDAP client and group filters can be configured on FortiGate.", "Advanced modeuses thee Windows convention –NetBIOS: Domain\\Username."],
        answer: "AC",
    ...
    },
    {
        ...
        options: ["The IPS scan is paused by the IPS diagnostic command with bypass mode option 5.", "The IPS socket buffer is full, andthe  IPS engine needs more memory to create new sessions.", "The IPS session scan is paused and reevaluating the packet because of a dirty flag.", "The IPS socket buffer is full, andthe  IPS engine cannot decode a packet."],
        answer: "B",
    ...
    {
        id: 88,
        question: "Refer to the exhibit. Which statement about this firewall policy list is true?  [cite: 2]",
        options: ["The firewall policies are listed by ID sequence view.", "The firewall policies are listed by ingress and egress interfaces pairing view.", "The Implicit group can include more than one deny firewall policy.", "LAN to WAN, WAN to LAN, and Implicit are sequence grouping view lists."],
        answer: "D",
    ...
    },
    {
        ...
        options: ["The default route on port2 is marked as the standby route.", "Both default routes have different administrative distances.", "The port2 interface is marked as inactive.", "All of the entries in the routing database table are installed in the FortiGate routing table"],
        answer: "AB",
    ...
    },
    {
        ...
        options: ["NGFW profile-based mode policies support both flow inspection and proxy inspection.", "NGFW profile-based mode supports applying applications and web filtering profiles in a firewall policy.", "NGFW profile-based mode can only be applied globally and not on individual VDOMs.", "NGFW profile-based mode must require the use of central source NAT policy."],
        answer: "AB",
        image: "images/q90.png"
    },
    {
        id: 91,
        question: "Refer to theexhibit showingg a FortiGuard connection debug output. Based on the output, which two facts does the administrator know about the FortiGuard connection? (Choose two.)[cite: 2]",
    ...
    {
        id: 93,
        question: "An administrator must enable a DHCP server on one of the directly connected networks on FortiGate. However, the administrator is unable to complete the process on the GUI to enable the service on the interface. Inthis scenarioo, whaprevents thehe administrator from enablithe ng DHCP service?[cite: 2]",
        options: ["The DHCP server setting is available only on the CLI.", "Another interface is configured as the only DHCP server on the FortiGate.", "The FortiGate model does not support the DHCP server.", "The role of the interface prevents setting a DHCP server."],
        answer: "D",
    ...
    },
    {
        ...
        options: ["The RPF check is a mechanism that protects FortiGate and the network from IP spoofing attacks.", "The RPF check is run on the firstreply packett of any new session.", "The RPF check is run on the first sent packet of any new session.", "The RPF check is run on the first sent and reply packet of any new session."],
        answer: "AC",
    ...
    {
        id: 97,
        question: "Refer to the exhibits. The SSL VPN connection fails when a userattempts too connect to it. What should the user do to successfully connect to the SSL VPN?[cite: 2]",
    ...
    },
    {
        ...
        options: ["The firewall policy does not apply deep content inspection.", "Web filter is not enabled on the firewall policy to complement the antivirus profile.", "The firewall policy is not configured in proxy-based inspection mode.", "The action on the firewall policy is not set to deny."],
        answer: "A",
    ...
    {
        id: 115,
        question: "Which method allows managementaccess too the FortiGate CLI without network connectivity?[cite: 2]",
    ...
    {
        id: 116,
        question: "Refer to the exhibit. FortiGate is configured for firewall authentication. When attempting to access an external website, the user is not presented with a login prompt. What is the most likely reason for this situation?[cite: 2]",
        options: ["The Service DNS is required in the firewall policy.", "The user is using an incorrect user name.", "No matching user account exists for this user.", "The Remote-users group is not added to the Destination."],
        answer: "A",
        image: "images/q116.png"
    },
    {
        id: 117,
        question: "Refer to the exhibit, which shows the IPS sensor configuration.n If traffic matches this IPS sensor, which two actions is the sensor expected to take? (Choose two.)[cite: 2]",
        options: ["The sensor will reset all connections that match these signatures.", "The sensor will gather a packet log for all matched traffic.", "The sensor will allow attackers matching the Microsoft.Windows.iSCSI.Target.DoS signature.", "The sensor will block all attacks aimed at Windows servers."],
        answer: "CD",
    ...
    },
    {
        id: 118,
        question: "Refer to the exhibit. FortiGate has two separate firewall policies for Sales and Engineering to access the same web server with the same security profiles. Which action must the administrator perform to consolidate the two policies into one?[cite: 2]",
        options: ["Create an Interface Group that includes port1 and port2 to create a single firewall policy.", "Enable Multiple Interface Policies to select port1 and port2 in the same firewall policy.", "Replace port1 and port2 with any interface in a single firewall policy.", "Select port1 and port2 subnets in a single firewall policy."],
        answer: "B",
    ...
    },
    {
        ...
        options: ["Certificate inspection", "Flow-based inspection", "Proxy-based inspection", "Full content inspection"],
        answer: "B",
